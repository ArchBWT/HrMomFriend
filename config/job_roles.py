JOB_ROLES = {
    "Software Development and Engineering": {
        "Frontend Developer": {
            ...
            "description": "Создает пользовательские интерфейсы и внедряет визуальные элементы",
        ...
        "Backend Developer": {
            ...
            "description": "Создание серверной логики и баз данных",
        ...
        "Full Stack Developer": {
            ...
            "description": "Осуществлять как клиентскую, так и серверную разработку",
        ...
        "Mobile App Developer": {
            ...
            "description": "Разработка мобильных приложений для платформ iOS и Android",
        ...
        "Game Developer": {
            ...
            "description": "Создает увлекательные и интерактивные игры",
    ...
    "Data Science and Analytics": {
        "Data Scientist": {
            ...
            "description": "Аналирует сложные наборы данных для поиска закономерностей",
        ...
        "Data Analyst": {
            ...
            "description": "Анализирует сложные данные",
        ...
        "Machine Learning Engineer": {
            ...
            "description": "Создание и развертывание моделей машинного обучения",
    ...
    "Cloud Computing and DevOps": {
        "Cloud Architect": {
            ...
            "description": "Проектирование и управление облачной инфраструктурой",
        ...
        "DevOps Engineer": {
            ...
            "description": "Внедрение методов и инструментов методом DevOps",
        ...
        "Site Reliability Engineer": {
            ...
            "description": "Обеспечивает надежность и производительность системы",
    ...
    "Cybersecurity": {
        "Security Analyst": {
            ...
            "description": "Мониторинг и защита от угроз",
        ...
        "Penetration Tester": {
            ...
            "description": "Тестирует системы на наличие уязвимостей",
            "sections": ["Technical Skills", "Security Projects", "Work Experience", "Certifications"],
            "recommended_skills": {
    ...
    "UI/UX Design": {
        "UI Designer": {
            ...
            "description": "Создают красивые пользовательские интерфейсы",
    ...
    "Project Management": {
        "Project Manager": {
            ...
            "description": "Руководить и управлять реализацией проекта",
        ...
        "Product Manager": {
            ...
            "description": "Определять и реализовать видение продукта",
