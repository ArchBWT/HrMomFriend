...
class ResumeBuilder:
    ...
    def build_modern_template(self, doc, data):
        ...
        try:
            ...
            if data['personal_info'].get('linkedin') or data['personal_info'].get('portfolio'):
                ...
                links_parts = []
                if data['personal_info'].get('linkedin'): links_parts.append(f"HH: {data['personal_info']['linkedin']}")
    ...
    def build_minimal_template(self, doc, data):
        ...
        try:
            ...
            # Links in one line
            links_parts = []
            if personal.get('linkedin'): links_parts.append(f"HH: {personal['linkedin']}")
